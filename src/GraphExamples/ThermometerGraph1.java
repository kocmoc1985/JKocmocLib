 ...
 *
 */
public class ThermometerGraph1 extends ApplicationFrame {
     ...
     */
    public ThermometerGraph1(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final ThermometerGraph1 demo = new ThermometerGraph1("Thermometer Demo 2");
        demo.pack();
