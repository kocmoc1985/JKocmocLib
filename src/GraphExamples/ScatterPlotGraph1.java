 ...
 *
 */
public class ScatterPlotGraph1 extends ApplicationFrame {
     ...
     */
    public ScatterPlotGraph1(final String title) {
...
//        chart.setLegend(null);
  ...
  //      panel.setHorizontalZoom(true);
    ...
    public static void main(final String[] args) {
        ...
        final ScatterPlotGraph1 demo = new ScatterPlotGraph1("Fast Scatter Plot Demo");
        demo.pack();
