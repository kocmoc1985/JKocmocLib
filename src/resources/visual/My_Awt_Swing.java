...
import static resources.MyRekursion.replaceComponentRecursively;

/**
 *
 * @author Administrator
 */
public class My_Awt_Swing {
            ...
            public void run() {
                synchronized (this) {
                    try {
                        ...
                        Logger.getLogger(My_Awt_Swing.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                //
