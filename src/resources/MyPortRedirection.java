 ...
 * @author KOCMOC
 */
public class MyPortRedirection {

    //WORKING TESTED BY ME (Ihtiandr)
    public static final int SOURCE_PORT = 1433;
    public static final String DESTINATION_HOST = "10.87.0.2";
    public static final int DESTINATION_PORT = 1433;
    ...
    public void run() {
        ...
        try {
            ...
            mServerSocket = new Socket(
                    MyPortRedirection.DESTINATION_HOST,
                    MyPortRedirection.DESTINATION_PORT);
