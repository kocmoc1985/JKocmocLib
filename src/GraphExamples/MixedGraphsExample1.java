 ...
 *
 */
public class MixedGraphsExample1 extends ApplicationFrame {
     ...
     */
    public MixedGraphsExample1(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final MixedGraphsExample1 demo = new MixedGraphsExample1("Pareto Chart Demo");
        demo.pack();
