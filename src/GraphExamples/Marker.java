...
public class Marker extends ApplicationFrame {
     ...
     */
    public Marker(final String title) {
...
//        chartPanel.setVerticalZoom(true);
  //      chartPanel.setHorizontalZoom(true);
    ...
    //    chart.getLegend().setAnchor(Legend.EAST);
        ...
        final ValueMarker start = new ValueMarker(200.0);
        ...
        final ValueMarker target = new ValueMarker(175.0);
        ...
        final ValueMarker originalEnd = new ValueMarker(millis);
        ...
        final ValueMarker currentEnd = new ValueMarker(millis);
...
//        plot.addAnnotation(bestBid);
    ...
    public static void main(final String[] args) {
        ...
        final Marker demo = new Marker("Marker Demo 1");
        demo.pack();
