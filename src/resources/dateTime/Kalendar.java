...
//        Kalendar kalendar = new Kalendar(1995, 2 - 1, 10);
//        c.add(kalendar);
        ...
        long x = kalendar.get_selected_date_and_time_as_millis("23:30");
        String curr_date = kalendar.get_current_date_YYYY_MM_DD();
    }
