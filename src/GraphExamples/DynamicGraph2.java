 ...
 *
 */
public class DynamicGraph2 extends ApplicationFrame implements ActionListener {
     ...
     */
    public DynamicGraph2(final String title) {
...
//        chart.getLegend().setAnchor(Legend.EAST);
  ...
  //      plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 4, 4, 4, 4));
    ...
    public static void main(final String[] args) {
        ...
        final DynamicGraph2 demo = new DynamicGraph2("Dynamic Data Demo 3");
        demo.pack();
