 ...
 */
public class LineDiagram1 extends ApplicationFrame implements ActionListener {
     ...
     */
    public LineDiagram1(final String title) {
...
//        this.plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 4, 4, 4, 4));
    ...
    public static void main(final String[] args) {
        ...
        final LineDiagram1 demo = new LineDiagram1("Multiple Dataset Demo 1");
        demo.pack();
