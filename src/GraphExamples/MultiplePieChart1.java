 ...
 */
public class MultiplePieChart1 extends ApplicationFrame {
     ...
     */
    public MultiplePieChart1(String title) {
    ...
    public static void main(String[] args) {
        MultiplePieChart1 demo = new MultiplePieChart1("Pie Chart Demo 7");
        demo.pack();
